...
public class Exercise_10 {
	public static void main(String[] args) {
		...
		while (!"course start".equalsIgnoreCase(input)) {
			...
			case "Remove":
				...
				break;
			case "Swap":
				String lessonToSwapp = inputCommand[2];
				swapLessons(schedule, lessonTitle, lessonToSwapp);
				break;
			case "Exercise":
				if (schedule.contains(lessonTitle)) {
	...
	private static void swapLessons(List<String> schedule, String lessonTitle, String swapWith) {
